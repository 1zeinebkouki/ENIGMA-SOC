...
![Wazuh custom rules catalog](./images/wazuh_rules_catalog.png)
...
![Wazuh–Shuffle webhook integration](./images/wazuh_shuffle_integration.png)
...
![Shuffle → TheHive alert creation, HTTP 201](./images/shuffle_thehive_alert_success.png)
...
![TheHive case list](./images/thehive_case_list.png)
...
![TheHive case detail](./images/thehive_case_detail.png)
